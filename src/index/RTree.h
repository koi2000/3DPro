...
///
template <class DATATYPE, class ELEMTYPE, int NUMDIMS, int TMAXNODES = 8, int TMINNODES = TMAXNODES / 2> class RTree {
  protected:
  ...
  public:
    ...
    /// array. \param a_resultCallback Callback function to return result.  Callback should return 'true' to continue
    /// searching \param a_context User context to pass as parameter to a_resultCallback \return Returns the number of
    /// entries found
